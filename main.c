...
// TIM1 CH2 - RB1, TIM1 CH3 - RF2, TIM2 CH2 - RF1, TIM2 CH3 - RB2, TIM3 CH1 - wheel_1, TIM3 CH2 - wheel, TIM4 CH3 - LFF, TIM4 CH3 - LFB임.
...
void smartcar_backward(void)
{
	...
	__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, 0);
		__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, del);
		__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_2, 0);
		__HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_3, del);
		__HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_1, 0);
		__HAL_TIM_SET_COMPARE(&htim3, TIM_CHANNEL_2, del);
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_3, 0);
		__HAL_TIM_SET_COMPARE(&htim4, TIM_CHANNEL_4, del);
}
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Trig_Pin|buzzer_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Trig_Pin buzzer_Pin */
